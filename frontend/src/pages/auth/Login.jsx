...
function GoogleLoginBtn({ disabled, onError }) {
  ...
  return (
    <button
      ...
      className="w-full h-11 rounded-xl border border-border bg-background hover:bg-muted/50 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-sm font-semibold text-foreground transition-all duration-200 hover:-translate-y-px active:translate-y-0 shadow-sm hover:shadow-md"
    >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              {GOOGLE_ENABLED && (
                <>
                  ...
                  <GoogleLoginBtn disabled={loading} onError={setServerError} />
                </>
              )}            </form>
          </div>
