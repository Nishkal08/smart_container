...
import { Sun, Moon, Search, CalendarDays, LogOut, ChevronDown, User } from 'lucide-react';
...
export default function TopNav() {
  ...
  return (
    <header className="flex shrink-0 items-center gap-3 rounded-xl glass-card px-4 py-2.5">
      {/* Search bar */}
      ...
      {/* User menu — visible on all screen sizes (mobile sign out lives here) */}
